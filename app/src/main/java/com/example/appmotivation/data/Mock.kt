...
class Mock {
    ...
    private val happy = MotivationConstants.FILTER.EMOJI
    ...
    fun getPhrase(value: Int, lang: String): String {
        val filteredList = mListPhrase.filter { (it.categoryId == value || value == all) && (it.lang == lang) }
        return filteredList[Random.nextInt(filteredList.size)].description
    }
}